...
sample_event = Event.create name: "john's camping trip", description: "going to yosemite", host_id: sample_host.id, address: "123 fake street"
...
another_event = Event.create name: "sespe backpacking", description: "Sespe Wilderness", host_id: sample_host.id, start_day: '01/03/13', start_time: '15:30'
